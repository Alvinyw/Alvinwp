    ...
    function widget($args, $instance) {
        ...
        <ul class="uk-list com">
            ...
            foreach ($comments as $key => $comment) {
                ...
                $output .= '<li class="uk-clearfix"><a href="' . get_comment_link() . '">' . get_avatar($comment->comment_author_email,36) . '<div class="author">'  . $comment->comment_author . '</div><div class="content">' . $comment->comment_content . '</div></a></li>';
            }
            echo $output;
            ?>
        </ul>
