            		...
            		<div id="index" class="bs uk-text-break">
            			<article id="article" class="uk-article">
					    	...
					    	<ul class="singlenav uk-breadcrumb">
					    		<li><i class="uk-icon-calendar"></i> <?php the_time('Y-m-d');?></li>
					    		<li><?php post_views(); ?></li>
					    		<li><i class="uk-icon-commenting-o"></i>  <?php comments_popup_link('0', '1', '%', '', ''); ?></li>
					    		<?php do_action('breadcrumb_qzhai');?>
					    		<?php if(of_get('is_like')){?>
					    		<li><i class="uk-icon-heart-o"></i> <?php if( get_post_meta($post->ID,'bigfa_ding',true) ){ echo get_post_meta($post->ID,'bigfa_ding',true);} else { echo '0';}?></li>
					    		<?php }?>
					    	</ul>
						    <?php
							...
							<div class="like_qzhai">
								<div class="like_men_qzhai">
							        ...
							        <em class="em01"><i class='uk-icon-heart'></i></em>
							        <em class="em02"><i class='uk-icon-heart'></i></em>
							        <em class="em03"><i class='uk-icon-heart'></i></em>
							        <em class="em04"><i class='uk-icon-heart'></i></em>
							        <em class="em05"><i class='uk-icon-heart'></i></em>
								</div>
							</div>
							<?php } ?>
