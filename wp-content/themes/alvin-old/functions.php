...
function myfooter()
{
	    //wp_enqueue_script('thoughtBubble', get_template_directory_uri() . '/js/jquery.thoughtBubble.js'); 点击头像冒泡
        wp_enqueue_script('qzhai', get_template_directory_uri() . '/js/app.js');
		wp_enqueue_script('alvin', get_template_directory_uri() . '/js/alvin.js');
		//wp_enqueue_script('canvas-clock', get_template_directory_uri() . '/js/canvas-clock.js'); Canvas 绘制时钟
