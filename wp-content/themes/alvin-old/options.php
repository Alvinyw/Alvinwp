...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('联系我', 'options_framework_theme'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Alvin', 'options_framework_theme'),
		'desc' => __('如果您在浏览我的博客过程中发现了什么错误或者有任何的困惑，请通过下面的 QQ 联系我~', 'options_framework_theme'),
		'type' => 'info');

	$options[] = array(
		'name' => __('私人QQ', 'options_framework_theme'),
		'desc' => __('欢迎加群一起探讨前端技术（1393950169）', 'options_framework_theme'),
		'type' => 'info');
	return $options;
}